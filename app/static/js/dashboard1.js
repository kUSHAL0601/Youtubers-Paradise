...
function chck2()
{
    if (document.getElementById('chsk_edit_psswd').checked) 
    {
	$('#edit_psswd').show();
    }
    else {
...
var opn = "<table style=\"width:100%\"><tr><td style=\"width:25%\"><div class=\"slideThree\" style=\"padding-left:0px;\"><input type=\"checkbox\" value=\"None\" class=\"w3check\" id=\""+ str + "check\" style=\"margin-left:15px; margin-right:10px;\" name=\"check\" style=\"padding:10px;\" /><label for=\"slideThree\" class=\"classname\">Loop</label></div></td><td style=\"width:25%\"><div class=\"slideThree\" style=\"width:130px; color:white; font-weight:bold;\"><span class=\"rating\"><input type=\"checkbox\" class=\"rating-input\" id=\"" + str + "ip\" name=\"rating-input-1\" style=\"display:none;\"><label for=\"" + str +"ip\" class=\"rating-star\" onclick=\"favcall('" + str + "');\"  style=\"margin-left:10px; margin-top: 5px; margin-right:10px;\" id =\"" + str + "fav\"></label></span><span style=\"height:100%; margin: 8px 5px 5px 5px;\">Favourite</span></div></td><td style=\"width:50%\"><div class=\"slideThree\" style=\"width:90px; color:white; font-weight:bold;\" id=\"" + str + "div\"><img src=\"../static/images/w21.jpg\" style=\"width:18px; height:18px; cursor:pointer; margin-left:10px; margin-top: 5px; margin-bottom: 5px; margin-right:10px;\" id=\"" + str + "wlnormal\" onclick=\"change1('" + str + "')\"></img><span style=\"padding-top:20px; margin-top:20px;\">Later</span></div></td></tr></table>";
